...
public class PrincipalWindow extends JFrame implements MouseListener {
	...
	private void buildComponents() {
		...
		lblLogo.setIcon(new ImagePanel().paintComponent(lblLogo, "src/main/java/icons/Vector.png"));
		...
		lblImage_1.setIcon(new ImagePanel().paintComponent(lblImage_1, "src/main/java/icons/megumi-chibi.png"));
